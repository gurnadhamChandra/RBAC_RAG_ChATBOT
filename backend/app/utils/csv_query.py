...
# DB_PATH = os.path.join(BASE_DIR, "roles.db")

# # DuckDB setup
# DUCKDB_FILE = "statics/data/structured_quiries.duckdb"

# # Ensure we can open or create DB; if invalid existing file is found, replace it
# try:
#     duck_conn = duckdb.connect(DUCKDB_FILE, read_only=False)
# except Exception as e:
#     from pathlib import Path
#     if isinstance(e, duckdb.IOException) or "not a valid DuckDB database" in str(e):
